...
export default function Scoreboard() {
  ...
  const loadScoreboard = async () => {
    try {
      // 1. Get scoreboard results (users with submissions)
      ...
      // Merge scoreboard with user list
      const scoreMap: any = {};
      (sb || []).forEach((u: any) => {
          ...
          >
            <g fill="none" stroke="none">
              <g transform="translate(0,0)" fill="#f8f2e8" opacity="0.95">
                ...
                <path
                  d="M96 18c4-2 10-6 14-6 2 0 4 2 4 4 0 4-6 8-10 10-6 2-20 6-20 6"
                  opacity="0.9"
                />
              </g>
              <g transform="translate(180,36) scale(0.9)" fill="#ff6b6b">
                ...
                <path
                  d="M0 24 q18 12 40 12 h32 q20 0 40 -12 v-4 h-112 z"
                  fill="#9f2b2b"
                  opacity="0.9"
                />
              </g>
              <g transform="translate(150,10) scale(0.45)" fill="#fff">
                ...
                <path
                  d="M12 12 q36 -18 60 0 q-8 2 -24 2 q-24 0 -36 -2 z"
                  fill="#e53e3e"
                />
              </g>
        ...
        {!ctfActive ? (
          <Card className="border-border bg-card/80 backdrop-blur-xl shadow-2xl">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-muted-foreground text-lg">
                The competition will begin soon. Stay tuned!
              </p>
            </CardContent>
          </Card>
        ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {topThree.map((entry, index) => {
                  ...
                  return (
                    <Card
                      key={entry.user_id}
                      className={`border bg-gradient-to-br ${bgGradient} backdrop-blur-xl shadow-xl`}
                    >
